...
Fitsy.getDataSlice=function(b,a,d,e,c,f){var g,j,l,m,h,p,q,n=Array.prototype.slice.call(arguments,6);switch(b.ftype){case "file":c&&(b.read.onloadend=function(){b.result="asString"===a?Fitsy.getBinaryString(b.read.result):b.read.result;c.apply(null,n)});f&&(b.read.onerror=function(){f.apply(null,n)});g=d||e?Fitsy.getFileSlice(b.file,d,e):b.file;b.read.readAsArrayBuffer(g);break;case "array":"asString"===a?(g=d||e?b.file.slice(d,e):b.file,b.result=Fitsy.getBinaryString(g)):(b.result=b.file,d&&e?(b.rlo=
d,b.rhi=e):(delete b.rlo,delete b.rhi));c&&c.apply(null,n);break;case "gzarray":d!==b.gz.here&&(Astroem.gzseek(b.gz.fd,d,0),b.gz.here=d);j=e-d;try{g=new Uint8Array(j)}catch(k){Fitsy.error("can't allocate enough memory to slice this FITS file",k)}l=Math.min(j,Fitsy.options.gzheapsize);p=Module._malloc(l);q=new Uint8Array(Module.HEAPU8.buffer,p,l);h=j;for(j=0;h;)m=Math.min(h,l),m=Astroem.gzread(b.gz.fd,q.byteOffset,m),0<m?(Fitsy.memcpy(g.buffer,j,Module.HEAPU8.buffer,p,m),j+=m,h-=m):h=0;Module._free(q.byteOffset);
b.gz.here=d+j;0<j?b.result="asString"===a?Fitsy.getBinaryString(g):g.buffer:b.eof=!0;c&&c.apply(null,n)}};Fitsy.getBinaryString=function(b){return String.fromCharCode.apply(null,new Uint8Array(b))};
...
Fitsy.isNumber=function(b){return!isNaN(parseFloat(b))&&isFinite(b)};Fitsy.xtypeof=function(b){return Object.prototype.toString.call(b).slice(8,-1)};Fitsy.cardpars=function(b){var a;if("="===b[8])return a=b.slice(0,8).trim(),b=b.slice(10).replace(/\'/g," ").replace(/\/.*/,"").trim(),"T"===b?b=!0:"F"===b?b=!1:Fitsy.isNumber(b)&&(b=parseFloat(b)),[a,b]};
Fitsy.readImageHDUDataConverter=function(b,a,d,e){var c,f,g,j,l,m;g=0;var h;a.dmin=Number.MAX_VALUE;a.dmax=Number.MIN_VALUE;a.filename=b.name;switch(b.ftype){case "array":b.rlo&&(g=b.rlo)}switch(a.bitpix){case 8:c=DataView.prototype.getUint8;f=DataView.prototype.setUint8;try{a.filedata=new Uint8Array(b.result,g)}catch(p){m=!0}break;case -16:c=DataView.prototype.getUint16;f=DataView.prototype.setUint16;try{a.filedata=new Uint16Array(b.result,g)}catch(q){m=!0}break;case 16:if(a.bzero&&32768===a.bzero){c=
DataView.prototype.getInt16;f=DataView.prototype.setUint16;try{a.filedata=new Uint16Array(b.result,g)}catch(n){m=!0}a.bitpix=-16}else{c=DataView.prototype.getInt16;f=DataView.prototype.setInt16;try{a.filedata=new Int16Array(b.result,g)}catch(k){m=!0}}break;case 32:c=DataView.prototype.getInt32;f=DataView.prototype.setInt32;try{a.filedata=new Int32Array(b.result,g)}catch(r){m=!0}break;case -32:c=DataView.prototype.getFloat32;f=DataView.prototype.setFloat32;try{a.filedata=new Float32Array(b.result,
g)}catch(s){m=!0}break;case -64:c=DataView.prototype.getFloat64;f=DataView.prototype.setFloat64;try{a.filedata=new Float64Array(b.result,g)}catch(t){m=!0}break;default:Fitsy.error("unsupported FITS BITPIX value: "+a.bitpix)}m&&Fitsy.error("can't allocate enough memory for this FITS image");a.image=a.filedata;m=a.bzero||0;b=new DataView(b.result);h=a.converted?Fitsy.hostEndian:!1;j=0;for(l=g;j<a.datapixls;j++,l+=a.pixlbytes)g=c.call(b,l,h)+m,isNaN(g)||(a.dmin=Math.min(a.dmin,g),a.dmax=Math.max(a.dmax,
g)),a.converted||f.call(b,l,g,Fitsy.hostEndian);a.converted=!0;e(a,d)};Fitsy.readImageHDUData=function(b,a,d,e){Fitsy.getDataSlice(b,"asArray",a.dataseek,a.dataseek+2880*a.databloks,Fitsy.readImageHDUDataConverter,Fitsy.readError,b,a,d,e)};
...
Fitsy.readTableHDUDataBinner=function(b,a,d,e,c){var f,g,j,l="true",m=0,h=e.table||Fitsy.options.table;if(!a.nev){a.filename=b.name;if(a.image&&a.image.length>=h.nx*h.ny)for(f=0;f<a.image.length;f++)a.image[f]=0;else a.image=new Int32Array(h.nx*h.ny);a.data=a.image;a.head=Fitsy.clone(a.filehead);a.card=Fitsy.clone(a.filecard);for(f=0;f<h.xcol.length&&void 0===a.table[h.xcol[f]];f++);a.colx=a.table[h.xcol[f]];for(f=0;f<h.ycol.length&&void 0===a.table[h.ycol[f]];f++);a.coly=a.table[h.ycol[f]]}a.filedata=
b.result;var p=a.colx,q=a.coly,n={nx:h.nx,ny:h.ny,width:h.nx,data:a.image},k={x:{type:p.type,offs:p.offs,min:Number(p.min),range:p.max-p.min+1},y:{type:q.type,offs:q.offs,min:Number(q.min),range:q.max-q.min+1},cx:h.cx,cy:h.cy,width:a.width,length:a.length,bin:h.bin,filter:h.filter};void 0===k.cx&&(k.cx=(p.max-p.min+1)/2);void 0===k.cy&&(k.cy=(q.max-q.min+1)/2);f={table:k,image:n,BinText:1===k.bin?"":"/"+Number(k.bin)};k.filter&&(j=Fitsy.tableFilter(a,k.filter),l=Fitsy.template(j,f));f.FilterText=
l;l=Fitsy.template(Fitsy.BinTableTemplate,f);try{g=(new Function(l))()}catch(r){Fitsy.error("An error occurred while generating the filter/binning function. Please check the filter syntax: "+k.filter)}a.view=new DataView(a.filedata);switch(b.ftype){case "array":b.rlo&&(m=b.rlo)}try{g(a.view,m,n,d)}catch(s){j?Fitsy.error("An error occurred while binning the table. Please check the filter syntax: "+j):Fitsy.error("An unknown error occurred while binning the table")}a.nev+=d;if(a.nev===a.length){a.table.bin=
h.bin;a.table.filter=h.filter;a.table.nx=h.nx;a.table.ny=h.ny;a.table.cx=k.cx;a.table.cy=k.cy;a.dmin=Number.MAX_VALUE;a.dmax=Number.MIN_VALUE;for(f=0;f<n.nx*n.ny;f++)a.dmin=Math.min(a.dmin,a.data[f]),a.dmax=Math.max(a.dmax,a.data[f]);a.axis[1]=n.nx;a.axis[2]=n.ny;a.head.NAXIS1=n.nx;a.head.NAXIS2=n.ny;a.card[0]=Fitsy.cardfmt("SIMPLE",0,!0,"Standard FITS Image");a.card[Fitsy.cardfind(a.card,"BITPIX",0)]=Fitsy.cardfmt("BITPIX",0,32,"FITS Data type.");a.card[Fitsy.cardfind(a.card,"NAXIS",0)]=Fitsy.cardfmt("NAXIS",
0,2,"Number of Axes");a.card[Fitsy.cardfind(a.card,"NAXIS1",1)]=Fitsy.cardfmt("NAXIS1",0,n.nx,"Axis Dimension");a.card[Fitsy.cardfind(a.card,"NAXIS2",1)]=Fitsy.cardfmt("NAXIS2",0,n.ny,"Axis Dimension");f=p.ith;Fitsy.cardcopy(a,"TCTYP"+f,a,"CTYPE1");Fitsy.cardcopy(a,"TCRVL"+f,a,"CRVAL1");Fitsy.cardcopy(a,"TCDLT"+f,a,"CDELT1",void 0,function(a){return a*k.bin});Fitsy.cardcopy(a,"TCRPX"+f,a,"CRPIX1",void 0,function(a){return(a-k.x.min)/k.bin+1});Fitsy.cardcopy(a,"TCROT"+f,a,"CROTA1");f=q.ith;Fitsy.cardcopy(a,
"TCTYP"+f,a,"CTYPE2");Fitsy.cardcopy(a,"TCRVL"+f,a,"CRVAL2");Fitsy.cardcopy(a,"TCDLT"+f,a,"CDELT2",void 0,function(a){return a*k.bin});Fitsy.cardcopy(a,"TCRPX"+f,a,"CRPIX2",void 0,function(a){return(a-k.y.min)/k.bin+1});Fitsy.cardcopy(a,"TCROT"+f,a,"CROTA2");Fitsy.cardcopy(a,"LTV1",a,"LTV1",0,function(){return n.nx/2-a.table.cx/k.bin});Fitsy.cardcopy(a,"LTV2",a,"LTV2",0,function(){return n.ny/2-a.table.cy/k.bin});Fitsy.cardcopy(a,"LTM1_1",a,"LTM1_1",1,function(a){return a/k.bin});Fitsy.cardcopy(a,
"LTM1_2",a,"LTM1_2",0,function(a){return a/k.bin});Fitsy.cardcopy(a,"LTM2_1",a,"LTM2_1",0,function(a){return a/k.bin});Fitsy.cardcopy(a,"LTM2_2",a,"LTM2_2",1,function(a){return a/k.bin});c(a,e)}else d=Math.min(a.length-a.nev,Fitsy.options.maxev),g=a.dataseek+a.nev*a.width,Fitsy.getDataSlice(b,"asArray",g,g+d*a.width,Fitsy.readTableHDUDataBinner,Fitsy.readError,b,a,d,e,c)};
Fitsy.cardfmt=function(b,a,d,e){switch(Fitsy.xtypeof(d)){case "Boolean":d=d?"T":"F";break;case "String":d="'"+d+"'";break;case "Number":d=d.toPrecision(15)}0!==a&&(b=(b+a.toFixed(0)).slice(0,8));b+=Fitsy.strrepeat(" ",8-b.length);b=b+"= "+d+" /"+e;return b+Fitsy.strrepeat(" ",80-b.length)};Fitsy.cardfind=function(b,a,d){var e;a+=Fitsy.strrepeat(" ",8-a.length);for(e=0;e<b.length;e++)if(b[e].slice(0,8)===a)return e;if(!0===d)return b[e]=b[e-1],e-1};
...
Fitsy.fetchURL=function(b,a,d,e){var c=new XMLHttpRequest;void 0===a&&(a=b,b=/([^\\\/]+)$/.exec(a)[1]);d=d||Fitsy.options;c.open("GET",a,!0);c.responseType="blob";c.onload=function(){var c;4===this.readyState&&(200===this.status||0===this.status?(c=new Blob([this.response]),c.name=b,d.messages&&d.messages(""),Fitsy.onFile([c],d,e)):404===this.status?Fitsy.error("could not find "+a):Fitsy.error("can't load "+a+" ("+this.status+")"))};c.onreadystatechange=function(){c.xtimeout&&(clearTimeout(c.xtimeout),
delete c.xtimeout)};d.messages&&(c.addEventListener("progress",function(a){d.messages("progress "+a.loaded.toString())}),c.addEventListener("error",function(){d.messages("error loading FITS file")}),c.addEventListener("abort",function(){d.messages("abort while loading FITS file")}));try{c.send()}catch(f){Fitsy.error("request to load "+a+" failed",f)}c.xtimeout=setTimeout(function(){Fitsy.error("timeout while waiting for response from server; "+a+" might not exist")},Fitsy.options.xtimeout)};
Fitsy.handleImageFile=function(b,a,d){void 0===a&&(a=Fitsy.options);void 0===d&&(d=Fitsy.handler);var e=new FileReader;e.onload=function(c){var f=new Image;f.src=c.target.result;f.onload=function(){var c,e,l=0,m;c=document.createElement("canvas");e=c.getContext("2d");var h=f.height,p=f.width;c.width=p;c.height=h;e.drawImage(f,0,0);var q=e.getImageData(0,0,p,h).data,n=new Float32Array(h*p);for(e=0;e<h;e++)for(c=0;c<p;c++)m=0.299*q[l]+0.587*q[l+1]+0.114*q[l+2],n[(h-e)*p+c]=m,l+=4;c={head:{},name:b.name,
filedata:n,image:n,naxis:2,axis:[0,p,h],bitpix:-32};c.dmin=Number.MAX_VALUE;c.dmax=Number.MIN_VALUE;for(l=0;l<h*p;l++)c.dmin=Math.min(c.dmin,c.image[l]),c.dmax=Math.max(c.dmax,c.image[l]);d(c,a)}};e.readAsDataURL(b)};
